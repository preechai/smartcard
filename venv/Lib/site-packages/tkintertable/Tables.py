...
class TableCanvas(Canvas):
    ...
    def do_bindings(self):
        ...
        self.parentframe.main.bind_all("<Right>", self.handle_arrow_keys)
        self.parentframe.main.bind_all("<Left>", self.handle_arrow_keys)
        self.parentframe.main.bind_all("<Up>", self.handle_arrow_keys)
        self.parentframe.main.bind_all("<Down>", self.handle_arrow_keys)
        self.parentframe.main.bind_all("<KP_8>", self.handle_arrow_keys)
        self.parentframe.main.bind_all("<Return>", self.handle_arrow_keys)
        self.parentframe.main.bind_all("<Tab>", self.handle_arrow_keys)
    ...
    def show(self, callback=None):
        """Adds column header and scrollbars and combines them with
           the current table adding all to the main frame provided in constructor.
    ...
    def createFilteringBar(self, parent=None, fields=None):
        ...
        if parent == None:
            ...
            x,y,w,h = self.getGeometry(self.main)
    ...
    def load(self, filename=None):
        ...
        if filename == None:
            filename = filedialog.askopenfilename(parent=self.main,
