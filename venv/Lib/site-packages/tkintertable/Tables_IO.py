...
class TableImporter:
    ...
    def import_Dialog(self, parent):
        ...
        self.parent=parent
        self.main=Toplevel()
        self.main.title("Import Data")
        self.xsize = 450
        self.ysize = 370
        top=self.main.winfo_toplevel()
        self.main.geometry('400x400+200+200')

        self.sep_choice = Combobox(self.main,
                            text = 'Record separator:',
                            textvariable = self.var_sep,
                            values = self.separator_list,
                            width = 4)
        self.var_sep.trace('w', self.update_display)
        Label(self.main,text='separator:').grid(row=0,column=0,sticky='nw',padx=2,pady=2)
        ...
        #buttons
        self.openButton = Button(self.main, text = 'Open File',
                command = self.do_openFile )
        self.openButton.grid(row=3,column=0,sticky='news',padx=2,pady=2)
        self.importButton = Button(self.main, text = 'Do Import',
